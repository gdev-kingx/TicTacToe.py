...
class TicTacToe:
    def __init__(self, game):
        self.game = game
        self.field_image = self.get_scaled_image(path='/Users/rsarvesh/Downloads/Python/TicTacToe/resources/field.png', res=[WIN_SIZE] * 2)
        self.O_image = self.get_scaled_image(path='/Users/rsarvesh/Downloads/Python/TicTacToe/resources/o.png', res=[CELL_SIZE] * 2)
        self.X_image = self.get_scaled_image(path='/Users/rsarvesh/Downloads/Python/TicTacToe/resources/x.png', res=[CELL_SIZE] * 2)
